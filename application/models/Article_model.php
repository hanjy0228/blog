...
//        $query = $this->db->query($sql);
    ...
    public function get_own_article_list($offset,$page_size){
        $this->db->select('*');
        $this->db->from('t_article a');
        $this->db->join('t_article_type t','a.type_id=t.type_id','left');
//        $this->db->where('a.user_id');
//        $this->db->order_by('a.article_id','desc');
    ...
    public function get_own_count_article(){
        $query=$this->db->get_where('t_article');
    ...
    public function get_own_article_type(){
//        $sql="select *,
